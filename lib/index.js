...
(function() {
	...
	* Objects.
	*/
	Validator.prototype.object = require( 'validate.io-object' );

	/**
	* Arrays.
	*/
	Validator.prototype.array = require( 'validate.io-array' );

	/**
	* Functions.
	*/
	Validator.prototype.function = require( 'validate.io-function' );
	...
	*/
	Validator.prototype.equals = function( value, comparator ) {
		...
		return ( value === parseFloat( comparator ) );
	}; // end METHOD equals()
	...
	*/
	Validator.prototype.properties = function( value, properties ) {
	...
	*/
	Validator.prototype.strict_properties = function( value, properties ) {
